...
\begin{figure}
    \centering
    \includegraphics[width = 0.7\textwidth]{../Rmd/lod-diff-prop-v-lrt.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{../Rmd/baseR-Hnf4a.jpg}
...
\begin{figure}
    \centering
    \includegraphics[height = 0.9\textheight]{../Rmd/baseR-12.jpg}
