...
We present a study into the complementary nature of our test of pleiotropy vs. separate QTL with causal mediation analyses. Our introduction begins with an overview of a framework for causal mediation analysis. We then discuss approaches to causal mediation analysis in systems genetics. 
